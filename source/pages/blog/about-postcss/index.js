      ...
      <main className="page__content">
        <article>
          ...
          <div className="chat">
            ...
            <div className="chat__message chat__message--in">
              <p className="paragraph">
                Всё началось из-за ненависти. Ненависти к{' '}
                <a href="http://compass-style.org/">Compass</a>. У них было
            ...
            <p className="paragraph chat__message chat__message--in">
              ...
              вводить фигурные скобки ({}) и точки с запятыми (;). В версии 4.3
              добавим больше API&nbsp;— парсер селекторов, парсер значений. А
              потом будет большой релиз 5.0, где мы исправим API, сделав его
